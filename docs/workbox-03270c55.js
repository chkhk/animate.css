    ...
    async getCacheKey(t, e) {
      ...
      if (!this.u[s]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = U(await t({mode: e, request: n, event: this.event, params: this.params}));
        this.u[s] = n;
      }
      return this.u[s];
    }
    ...
    k() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== C.copyRedirectedCacheableResponsesPlugin &&
          (n === C.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
      0 === e
  ...
  class E {
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if ((this.K.set(i, t), this.T.set(i, r), e.length > 0)) {
...
//# sourceMappingURL=workbox-03270c55.js.map
